...
//   const cardWidth = 296;
//   const padding = 32;
//   const cardWidthMedia = 150;
//   const paddingMedia = 16;
//   const countSlide = [...document.querySelectorAll('.item')].length;
//   console.log(countSlide);
//   const cardSliderLine = document.querySelector('.other__line');
//   const cardBtnPred = document.querySelector('.other__pred');
//   const cardBtnNext = document.querySelector('.other__next');
//   let widthOffset = 0;
  
//   cardBtnNext.addEventListener('click', function(event){
//     event.preventDefault();
//     if (userWidth > 721) {
//       offset += cardWidth + padding;
//       cardSliderLine.style.left = -offset + 'px'
//     }
//     else {
//       offset += cardWidthMedia + paddingMedia;
//     }
//   })

//   cardBtnPred.addEventListener('click', function(event){
//     event.preventDefault();
//     if (userWidth > 721) {
//       offset += cardWidth + padding;
//       cardSliderLine.style.left = offset + 'px'
